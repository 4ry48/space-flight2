...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("The asteroids have hit the planet please press r to ",canvas.width/2-400,canvas.height/2+100);
    text("try again",canvas.width/2-400,canvas.height/2+150)
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("------asteroid belt blasters------",canvas.width/2-300,canvas.height/2-300);
    ...
    text("  You are a pilot of space fighter IX_27/G.",canvas.width/2-300,canvas.height/2-170);
    text("  Help the people and the planet Earth !",canvas.width/2-300,canvas.height/2-130);
    text("  press 'space' to shoot you'r ion cannons.",canvas.width/2-300,canvas.height/2-90);
